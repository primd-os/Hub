...
execute in hub:hub run summon minecraft:area_effect_cloud 1 98 -15 {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["h.segment_loader"]}
function hub:start/load_segments
execute as @e[tag=h.segment_loader] at @s run tp @s ~-4 ~ ~4
