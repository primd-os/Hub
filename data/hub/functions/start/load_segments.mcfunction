...
fill ~ ~-1 ~ ~ ~ ~ air
execute unless data storage hub:hub doorwayflip[0].flip run setblock ~-6 ~-2 ~3 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",posX:0,mode:"LOAD",posY:0,posZ:5,name:""}
execute if data storage hub:hub doorwayflip[0].flip run setblock ~-6 ~-2 ~3 minecraft:structure_block[mode=load]{rotation:"NONE",posX:-10,mode:"LOAD",posY:0,posZ:-3,name:""}
...
execute if data storage hub:hub doorways[0] unless data storage hub:hub doorwayflip[0].flip run setblock ~1 ~-2 ~3 minecraft:structure_block[mode=load]{rotation:"NONE",posX:0,mode:"LOAD",posY:0,posZ:-3,name:""}
execute if data storage hub:hub doorwayflip[0].flip run setblock ~1 ~-2 ~3 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",posX:10,mode:"LOAD",posY:0,posZ:5,name:""}
