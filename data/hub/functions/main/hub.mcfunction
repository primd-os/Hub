...
item replace entity @s hotbar.0 with written_book{title:"Navigation Book",author:"PRIMD Team",resolved:0b} 1
data modify storage hub:hub navigation_book set value []
data modify storage hub:hub navigation_book append value '{"text":"      -= ","color":"gray","extra":[{"text":"P","extra":[{"text":"R","color":"red"},"I",{"text":"M","color":"dark_blue"},"D"],"underlined":true,"color":"dark_gray"},{"text":" =-","color":"gray"}]}'
data modify storage hub:hub navigation_book append value '{"text":"       Navigation","color":"dark_blue"}'
...
function hub:main/fill_navigation