...
execute as @a[x=-4,y=138,z=9,distance=..2] run advancement grant @s only hub:parkour_god
...
execute as @a[x=-5,y=134,z=8,distance=..1.5,tag=Parkour] run advancement grant @s only hub:parkour
execute as @a[x=-5,y=134,z=8,distance=..1.5,tag=Parkour] if score @s h.Timer matches ..720 run advancement grant @s only hub:fast_parkour
