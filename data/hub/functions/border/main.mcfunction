...
execute as @e[type=marker,tag=hub.border] if score @s hub.borderChangeLength matches 1.. run scoreboard players operation @s hub.borderCeiling += @s hub.borderCeilingChange
