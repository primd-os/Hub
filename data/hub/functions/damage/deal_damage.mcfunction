...
execute if score newHealth hub.Variables matches ..10 run scoreboard players add newHealth m.Variables 10
...
execute if score newHealth hub.Variables matches ..15 run scoreboard players add newHealth m.Variables 5
...
execute if score newHealth hub.Variables matches ..17 run scoreboard players add newHealth m.Variables 2
...
execute if score newHealth hub.Variables matches ..18 run scoreboard players add newHealth m.Variables 2
...
execute if score newHealth hub.Variables matches ..19 run scoreboard players add newHealth m.Variables 1
